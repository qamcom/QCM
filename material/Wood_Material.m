...
classdef Wood_Material < handle
    
    methods
        
        function  m=Wood_Material
        end
        ...
        function y = SurfaceCoeff(m,freqs,elevation0,elevation1,azimuth0,azimuth1,pol0,pol1,radius0,radius1,res)
            ...
            penetrationLoss = repmat(20,Np,Nf); % dB
            scatteringLoss  = repmat(40,Np,Nf); % dB
            reflectionLoss  = repmat(20,Np,Nf);  % dB
